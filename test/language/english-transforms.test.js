...
const tests = [
    ...
    },
    {
        ...
        tests: [
            ...
            {term: 'come', source: 'came',  rule: 'v', reasons: ['past']},
            {term: 'run', source: 'ran',  rule: 'v', reasons: ['past']},
            {term: 'leave', source: 'left',  rule: 'v', reasons: ['past']},
            {term: 'see', source: 'saw',  rule: 'v', reasons: ['past']},
            {term: 'strike', source: 'struck',  rule: 'v', reasons: ['past']},
            {term: 'be', source: 'was',  rule: 'v', reasons: ['past']},
            {term: 'be', source: 'were',  rule: 'v', reasons: ['past']},
            ...
            {term: 'be', source: 'being',  rule: 'v', reasons: ['ing']},
            ...
            {term: 'be', source: 'am',  rule: 'v', reasons: ['present']},
            {term: 'be', source: 'are',  rule: 'v', reasons: ['present']},
            {term: 'be', source: 'is',  rule: 'v', reasons: ['3rd pers. sing. pres']},
    ...
    },
    {
        ...
        tests: [
            ...
            {term: 'come into', source: 'came into',  rule: 'v_phr', reasons: ['past']},
            {term: 'run into', source: 'ran into',  rule: 'v_phr', reasons: ['past']},
            {term: 'leave behind', source: 'left behind',  rule: 'v_phr', reasons: ['past']},
            {term: 'strike down', source: 'struck down',  rule: 'v_phr', reasons: ['past']},
        ],
    },
    {
        category: 'adverbs',
