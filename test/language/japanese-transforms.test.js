...
const tests = [
    ...
    },
    {
        ...
        tests: [
            ...
            {term: '行く', source: '行ったら',         rule: 'v5', reasons: ['-たら']},
            {term: '行く', source: '行ったり',         rule: 'v5', reasons: ['-たり']},
            ...
            {term: '行く', source: '行っとく',         rule: 'v5', reasons: ['-て', '-おく']},
    ...
    {
        category: '-く irregular verbs reject regular ta/te stems',
        valid: false,
        tests: [
            {term: '行く', source: '行いた',           rule: 'v5', reasons: ['-た']},
            {term: '行く', source: '行いて',           rule: 'v5', reasons: ['-て']},
            {term: '行く', source: '行いたら',         rule: 'v5', reasons: ['-たら']},
            {term: '行く', source: '行いたり',         rule: 'v5', reasons: ['-たり']},
            {term: '行く', source: '行いとく',         rule: 'v5', reasons: ['-て', '-おく']},
            {term: '逝く', source: '逝いた',           rule: 'v5', reasons: ['-た']},
            {term: '逝く', source: '逝いて',           rule: 'v5', reasons: ['-て']},
            {term: 'いく', source: 'いいた',           rule: 'v5', reasons: ['-た']},
            {term: 'いく', source: 'いいて',           rule: 'v5', reasons: ['-て']},
        ],
    },
    {
        category: '-る godan exceptions from SLJFAQ',
        valid: true,
        tests: [
            {term: '入る', source: '入って',       rule: 'v5', reasons: ['-て']},
            {term: '千切る', source: '千切って',   rule: 'v5', reasons: ['-て']},
            {term: '滅入る', source: '滅入って',   rule: 'v5', reasons: ['-て']},
            {term: '捻る', source: '捻って',       rule: 'v5', reasons: ['-て']},
            {term: '火照る', source: '火照って',   rule: 'v5', reasons: ['-て']},
            {term: '湿気る', source: '湿気って',   rule: 'v5', reasons: ['-て']},
            {term: '蘇る', source: '蘇って',       rule: 'v5', reasons: ['-て']},
            {term: 'びびる', source: 'びびって',   rule: 'v5', reasons: ['-て']},
            {term: 'くねる', source: 'くねって',   rule: 'v5', reasons: ['-て']},
            {term: 'のめる', source: 'のめって',   rule: 'v5', reasons: ['-て']},
            {term: '耽る', source: '耽って',       rule: 'v5', reasons: ['-て']},
        ],
    },
    {
        category: '-る godan exceptions reject ichidan-shaped te forms',
        valid: false,
        tests: [
            {term: '入る', source: '入て',       rule: 'v5', reasons: ['-て']},
            {term: '千切る', source: '千切て',   rule: 'v5', reasons: ['-て']},
            {term: '滅入る', source: '滅入て',   rule: 'v5', reasons: ['-て']},
            {term: '捻る', source: '捻て',       rule: 'v5', reasons: ['-て']},
            {term: '火照る', source: '火照て',   rule: 'v5', reasons: ['-て']},
            {term: '湿気る', source: '湿気て',   rule: 'v5', reasons: ['-て']},
            {term: '蘇る', source: '蘇て',       rule: 'v5', reasons: ['-て']},
            {term: 'びびる', source: 'びびて',   rule: 'v5', reasons: ['-て']},
            {term: 'くねる', source: 'くねて',   rule: 'v5', reasons: ['-て']},
            {term: 'のめる', source: 'のめて',   rule: 'v5', reasons: ['-て']},
            {term: '耽る', source: '耽て',       rule: 'v5', reasons: ['-て']},
        ],
    },
    {
        category: '-ぐ verbs',
    ...
    {
        category: 'historical spelling and classical forms',
        valid: true,
        tests: [
            {term: '來る', source: '來れり', rule: 'vk', reasons: ['classical perfective']},
            {term: '就く', source: '就きて', rule: 'v5', reasons: ['-て']},
            {term: '數える', source: '數ふる', rule: 'v1', reasons: ['classical nidan attributive']},
            {term: '耐える', source: '耐ふる', rule: 'v1', reasons: ['classical nidan attributive']},
            {term: '燒く', source: '燒かるる', rule: 'v5', reasons: ['passive']},
            {term: '成る', source: '成りたる', rule: 'v5', reasons: ['classical perfective']},
            {term: 'かんがえる', source: 'かんがへませう', rule: 'v1', reasons: ['-ます', 'volitional', 'historical spelling']},
            {term: 'こころ', source: 'こゝろ', rule: null, reasons: ['historical spelling']},
            {term: 'つづける', source: 'つゞけられた', rule: 'v1', reasons: ['potential or passive', '-た', 'historical spelling']},
            {term: 'いっしょに', source: 'いつしよに', rule: null, reasons: ['historical spelling', 'historical spelling']},
            {term: 'ほんとう', source: 'ほんたう', rule: null, reasons: ['historical spelling']},
            {term: 'かえって', source: 'かへつて', rule: null, reasons: ['historical spelling', 'historical spelling']},
            {term: 'ふるえる', source: 'ふるへてゐる', rule: 'v1', reasons: ['-て', '-いる', 'historical spelling']},
            {term: 'せわしい', source: 'せはしく', rule: 'adj-i', reasons: ['-く', 'historical spelling']},
            {term: 'ただ', source: 'たゞ', rule: null, reasons: ['historical spelling']},
            {term: 'よう', source: 'やう', rule: null, reasons: ['historical spelling']},
            {term: '教える', source: '教ふる', rule: 'v1', reasons: ['classical nidan attributive']},
            {term: '癒える', source: '癒ゆる', rule: 'v1', reasons: ['classical nidan attributive']},
            {term: '絶える', source: '絶ゆる', rule: 'v1', reasons: ['classical nidan attributive']},
            {term: '救う', source: '救はるる', rule: 'v5', reasons: ['passive']},
        ],
    },
    {
        category: 'guarded classical forms do not steal bare modern words',
        valid: false,
        tests: [
            {term: 'く', source: 'きて', rule: 'v5', reasons: ['-て']},
        ],
    },
    {
