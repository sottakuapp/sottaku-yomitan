...
/**
 * Mark a historical-kana spelling as recognition-only for Sottaku's exported
 * server rules. Yomitan itself ignores the extra metadata and keeps its normal
 * deinflection behavior.
 * @param {string} inflectedSuffix
 * @param {string} deinflectedSuffix
 * @param {Condition[]} conditionsIn
 * @param {Condition[]} conditionsOut
 * @returns {import('language-transformer').SuffixRule<Condition> & {sottakuDeinflectionOnly: true}}
 */
function historicalKanaSuffixInflection(inflectedSuffix, deinflectedSuffix, conditionsIn, conditionsOut) {
    return {
        ...suffixInflection(inflectedSuffix, deinflectedSuffix, conditionsIn, conditionsOut),
        sottakuDeinflectionOnly: true,
    };
}
    ...
    transforms: {
        '-ば': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('へば', 'う', ['-ば'], ['v5']),
        ...
        '-そう': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('さう', 'い', [], ['adj-i']),
                suffixInflection('そう', 'る', [], ['v1']),
                historicalKanaSuffixInflection('さう', 'る', [], ['v1']),
                suffixInflection('いそう', 'う', [], ['v5']),
                historicalKanaSuffixInflection('ひさう', 'う', [], ['v5']),
                suffixInflection('きそう', 'く', [], ['v5']),
                historicalKanaSuffixInflection('きさう', 'く', [], ['v5']),
                suffixInflection('ぎそう', 'ぐ', [], ['v5']),
                historicalKanaSuffixInflection('ぎさう', 'ぐ', [], ['v5']),
                suffixInflection('しそう', 'す', [], ['v5']),
                historicalKanaSuffixInflection('しさう', 'す', [], ['v5']),
                suffixInflection('ちそう', 'つ', [], ['v5']),
                historicalKanaSuffixInflection('ちさう', 'つ', [], ['v5']),
                suffixInflection('にそう', 'ぬ', [], ['v5']),
                historicalKanaSuffixInflection('にさう', 'ぬ', [], ['v5']),
                suffixInflection('びそう', 'ぶ', [], ['v5']),
                historicalKanaSuffixInflection('びさう', 'ぶ', [], ['v5']),
                suffixInflection('みそう', 'む', [], ['v5']),
                historicalKanaSuffixInflection('みさう', 'む', [], ['v5']),
                suffixInflection('りそう', 'る', [], ['v5']),
                historicalKanaSuffixInflection('りさう', 'る', [], ['v5']),
                suffixInflection('じそう', 'ずる', [], ['vz']),
                historicalKanaSuffixInflection('じさう', 'ずる', [], ['vz']),
                suffixInflection('しそう', 'する', [], ['vs']),
                historicalKanaSuffixInflection('しさう', 'する', [], ['vs']),
                suffixInflection('為そう', '為る', [], ['vs']),
                historicalKanaSuffixInflection('為さう', '為る', [], ['vs']),
                suffixInflection('きそう', 'くる', [], ['vk']),
                historicalKanaSuffixInflection('きさう', 'くる', [], ['vk']),
                suffixInflection('来そう', '来る', [], ['vk']),
                historicalKanaSuffixInflection('来さう', '来る', [], ['vk']),
                suffixInflection('來そう', '來る', [], ['vk']),
                historicalKanaSuffixInflection('來さう', '來る', [], ['vk']),
            ],
        },
        '-すぎる': {
            name: '-すぎる',
        ...
        '-ず': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('はず', 'う', [], ['v5']),
        ...
        '-ぬ': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('はぬ', 'う', [], ['v5']),
        ...
        '-ん': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('はん', 'う', ['-ん'], ['v5']),
        ...
        '-んばかり': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('はんばかり', 'う', [], ['v5']),
        ...
        '-んとする': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('はんとする', 'う', ['vs'], ['v5']),
        ...
        '-む': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('はむ', 'う', [], ['v5']),
        ...
        '-ざる': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('はざる', 'う', [], ['v5']),
        ...
        '-ねば': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('はねば', 'う', ['-ば'], ['v5']),
        ...
        'causative': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('はせる', 'う', ['v1'], ['v5']),
        ...
        'short causative': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('はす', 'う', ['v5sp'], ['v5']),
        ...
        'imperative': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('へ', 'う', [], ['v5']),
        ...
        'continuative': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('ひ', 'う', [], ['v5']),
        ...
        'negative': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('はない', 'う', ['adj-i'], ['v5']),
        ...
        'passive': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('はれる', 'う', ['v1'], ['v5']),
        ...
        '-ます': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('ひます', 'う', ['-ます'], ['v5d']),
        ...
        'volitional': {
            ...
            rules: [
                ...
                historicalKanaSuffixInflection('やう', 'る', [], ['v1']),
                suffixInflection('おう', 'う', [], ['v5']),
                historicalKanaSuffixInflection('はう', 'う', [], ['v5']),
                suffixInflection('こう', 'く', [], ['v5']),
                historicalKanaSuffixInflection('かう', 'く', [], ['v5']),
                suffixInflection('ごう', 'ぐ', [], ['v5']),
                historicalKanaSuffixInflection('がう', 'ぐ', [], ['v5']),
                suffixInflection('そう', 'す', [], ['v5']),
                historicalKanaSuffixInflection('さう', 'す', [], ['v5']),
                suffixInflection('とう', 'つ', [], ['v5']),
                historicalKanaSuffixInflection('たう', 'つ', [], ['v5']),
                suffixInflection('のう', 'ぬ', [], ['v5']),
                historicalKanaSuffixInflection('なう', 'ぬ', [], ['v5']),
                suffixInflection('ぼう', 'ぶ', [], ['v5']),
                historicalKanaSuffixInflection('ばう', 'ぶ', [], ['v5']),
                suffixInflection('もう', 'む', [], ['v5']),
                historicalKanaSuffixInflection('まう', 'む', [], ['v5']),
                suffixInflection('ろう', 'る', [], ['v5']),
                historicalKanaSuffixInflection('らう', 'る', [], ['v5']),
                suffixInflection('じよう', 'ずる', [], ['vz']),
                historicalKanaSuffixInflection('じやう', 'ずる', [], ['vz']),
                suffixInflection('しよう', 'する', [], ['vs']),
                historicalKanaSuffixInflection('しやう', 'する', [], ['vs']),
                suffixInflection('為よう', '為る', [], ['vs']),
                historicalKanaSuffixInflection('為やう', '為る', [], ['vs']),
                suffixInflection('こよう', 'くる', [], ['vk']),
                historicalKanaSuffixInflection('こやう', 'くる', [], ['vk']),
                suffixInflection('来よう', '来る', [], ['vk']),
                historicalKanaSuffixInflection('来やう', '来る', [], ['vk']),
                suffixInflection('來よう', '來る', [], ['vk']),
                historicalKanaSuffixInflection('來やう', '來る', [], ['vk']),
                suffixInflection('ましょう', 'ます', [], ['-ます']),
                historicalKanaSuffixInflection('ませう', 'ます', [], ['-ます']),
                suffixInflection('かろう', 'い', [], ['adj-i']),
                historicalKanaSuffixInflection('からう', 'い', [], ['adj-i']),
            ],
        },
        'volitional slang': {
