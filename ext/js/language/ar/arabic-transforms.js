...
export const arabicTransforms = {
    ...
    transforms: {
        ...
        'NBrokenPlural-Reviewed': {
            name: 'broken plural',
            description: 'Reviewed definite broken-plural surfaces from Sottaku sentences',
            rules: [
                wholeWordInflection('الأطفال', 'طفل', ['n'], ['n']),
                wholeWordInflection('الطلاب', 'طالب', ['n'], ['n']),
                wholeWordInflection('الزوار', 'زائر', ['n'], ['n']),
                wholeWordInflection('الجبال', 'جبل', ['n'], ['n']),
                wholeWordInflection('الدول', 'دولة', ['n'], ['n']),
                wholeWordInflection('المدن', 'مدينة', ['n'], ['n']),
                wholeWordInflection('المرضى', 'مريض', ['n'], ['n']),
                wholeWordInflection('النتائج', 'نتيجة', ['n'], ['n']),
            ],
        },
        ...
        'IVPref-hw': {
            ...
            rules: [
                ...getImperfectRules('ي', '', '', ''),
                wholeWordInflection('يحتاج', 'احتاج', ['v'], ['v']),
                wholeWordInflection('يحمي', 'حمى', ['v'], ['v']),
                wholeWordInflection('يصل', 'وصل', ['v'], ['v']),
                wholeWordInflection('يؤدي', 'أدى', ['v'], ['v']),
                wholeWordInflection('يكفي', 'كفى', ['v'], ['v']),
                wholeWordInflection('يعتمد', 'اعتمد', ['v'], ['v']),
                wholeWordInflection('يقع', 'وقع', ['v'], ['v']),
                wholeWordInflection('يقيس', 'قاس', ['v'], ['v']),
            ],
        },
        'IVPref-hy': {
            name: 'Imperfect Tense',
            ...
            rules: [
                ...getImperfectRules('ت', '', '', ''),
                wholeWordInflection('تحتاج', 'احتاج', ['v'], ['v']),
                wholeWordInflection('تحمي', 'حمى', ['v'], ['v']),
                wholeWordInflection('تؤدي', 'أدى', ['v'], ['v']),
                wholeWordInflection('تكفي', 'كفى', ['v'], ['v']),
                wholeWordInflection('تجتمع', 'اجتمع', ['v'], ['v']),
                wholeWordInflection('تختلف', 'اختلف', ['v'], ['v']),
                wholeWordInflection('تنمو', 'نما', ['v'], ['v']),
            ],
        },
        'IVPref-hmA': {
            name: 'Imperfect Tense',
